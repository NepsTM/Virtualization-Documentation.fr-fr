...
Si vous prévoyez d’utiliser le conteneur Hyper-V et que vous avez l’hyperviseur Hyper-V installé sur votre hôte Nano Server, vous pouvez aussi extraire l’image de Server Core. Si vous exécutez Azure Gallery Server2016 Nano, attendez-vous à ce que Hyper-V ne soit pas installé.
