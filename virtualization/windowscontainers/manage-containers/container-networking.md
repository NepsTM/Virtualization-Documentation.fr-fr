...
# <a name="details-on-windows-container-networking"></a>Détails de la mise en réseau de conteneur Windows

## <a name="isolation-namespace-with-network-compartments"></a>Isolation (espace de noms) avec compartiments réseau
...
## <a name="windows-firewall-security"></a>Sécurité du pare-feu Windows
...
#### <a name="moby-linux-vms-use-dockernat-switch-with-docker-for-windows-a-product-of-docker-cehttpswwwdockercomcommunity-edition-instead-of-hns-internal-vswitch"></a>Les machines virtuelles Moby Linux utilisent le commutateur DockerNAT avec Docker pour Windows (un produit de [Docker CE](https://www.docker.com/community-edition)) au lieu du vSwitch interne HNS 
