...
\***Remarque**: DockerSwarm sur WindowsServer2016 nécessite [KB4015217](https://support.microsoft.com/en-us/help/4015217/windows-10-update-kb4015217)
...
```
## Clusters avec systèmes d’exploitation mixtes Linux + Windows
...
### Initialisation d’un cluster avec systèmes d’exploitation mixtes Linux + Windows
...
### Ajout d'étiquettes à des nœuds de cluster Swarm
...
### Déploiement de services dans un cluster Swarm à systèmes d'exploitation mixtes
...
## Publication de ports pour les points de terminaison du service
...
#### *Un réseau transparent existant peut bloquer l’initialisation d'un cluster Swarm ou la création d'un réseau de superposition* 
