...
* En tant que session persistante (build 14280 et ultérieures) : [cliquez ici](#copy-files-with-new-pssession-and-copy-item) pour créer une session persistante à l’aide de New-PSSession.  
