...
* Hôte : Windows 10, Windows Server Technical Preview 2 ou version ultérieure exécutant Hyper-V.
* Invité/Machine virtuelle : Windows 10, Windows Server Technical Preview 2 ou version ultérieure.
...
> Remarque : Si votre session ne se connecte pas, voir la section de [dépannage](vmsession.md#troubleshooting) pour déterminer les causes potentielles. 
